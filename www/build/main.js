...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/app/app.html"*/'<!--<ion-split-pane [when]="isiPad">-->\n  <ion-menu [content]="content">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content scrollbar-y-auto on-swipe-right="menuOpen">\n      <ion-list>\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n      </ion-list>\n    </ion-content>\n\n  </ion-menu>\n\n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n<!--</ion-split-pane>-->'/*ion-inline-end:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/app/app.html"*/
        }),
...
var About = /** @class */ (function () {
    ...
    About = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-about",template:/*ion-inline-start:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>About</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding scrollbar-y-auto>\n  <div style="text-align: center;">\n    <img style="margin-top: 20px;" src="/assets/img/splash.png" />\n  </div>\n  <div style="text-align: center;">\n    <a href="https://www.mothertongues.org">\n      <img\n        style="width: 150px; margin-top: 30px;"\n        href="https://www.mothertongues.org"\n        src="/assets/img/logo.png"\n      />\n    </a>\n    <p>UI version {{ version }}</p>\n  </div>\n  <p style="text-align: center;">{{ build }}</p>\n</ion-content>\n'/*ion-inline-end:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/about/about.html"*/
        }),
...
var Bookmarks = /** @class */ (function () {
    ...
    Bookmarks = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-bookmarks",template:/*ion-inline-start:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/bookmarks/bookmarks.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Bookmarks</ion-title>\n    <ion-buttons right>\n      <button ion-button (click)="edit = !edit">\n      <ion-icon name="trash" *ngIf="!edit"></ion-icon>\n      <span *ngIf="edit">cancel</span>\n    </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding scrollbar-y-auto>\n  <entry-list [entries]=\'bookmarks\' [parentEdit]="edit"></entry-list>\n  <div class=\'center\'>\n    <button ion-button color="danger" class="remove" *ngIf="edit" (click)="removeEntries(bookmarks)">Remove selected bookmarks</button>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/bookmarks/bookmarks.html"*/
            // providers: [EntryList]
        }),
...
var Random = /** @class */ (function () {
    ...
    Random = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-random',template:/*ion-inline-start:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/random/random.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Random</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding scrollbar-y-auto>\n  <div class="center"><button ion-button color="ternary" (click)=\'getRandom()\'>Click here for 10 Random words</button></div>\n  <div class="entry-container" *ngIf="entries">\n    <entry-list [entries]="entries"></entry-list>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/chad/Documents/FirstVoices/Code/MotherTonguesDictionary/mothertongues-UI/src/pages/random/random.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], Random);
    return Random;
